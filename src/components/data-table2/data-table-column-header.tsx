        ...
        >
          ...
          <SelectIcon asChild>
            {column.getCanSort() && column.getIsSorted() === "desc" ? (
              <ArrowDown
                className="ml-2.5 w-4 h-4 stroke-1"
                aria-hidden="true"
              />
            ) : column.getIsSorted() === "asc" ? (
              <ArrowUp className="ml-2.5 w-4 h-4 stroke-1" aria-hidden="true" />
            ) : (
              <ChevronsUpDown
                className="ml-2.5 w-4 h-4 stroke-1"
                aria-hidden="true"
            ...
            <>
              <SelectItem value={ascValue}>
                <span className="flex items-center">
                  <ArrowUp
                    className="mr-2 w-4 h-4 stroke-1 text-muted-foreground/70"
                    aria-hidden="true"
                  />
                  Asc
                </span>
              ...
              <SelectItem value={noneValue}>
                <span className="flex items-center gap-2">
                  <X
                    className="w-4 h-4 stroke-1 text-muted-foreground/70"
                    aria-hidden="true"
                  />
                  Reset
                </span>

    ...
    >
      <Popover>
        <PopoverTrigger asChild>
          ...
          >
            <ArrowDownUp className="w-4 h-4 stroke-1" />
            Sort
                      ...
                      >
                          ...
                          <PopoverTrigger asChild>
                            ...
                            >
                              ...
                              <div className="ml-auto flex items-center gap-1">
                                ...
                                <ChevronsUpDown className="w-4 h-4 stroke-1 shrink-0 opacity-50" />
                              </div>
                            </Button>
                          </PopoverTrigger>
                          <PopoverContent
                                ...
                                <CommandGroup>
                                  {sortableColumns.map((column) => (
                                    ...
                                    >
                                      ...
                                      <Check
                                        className={cn(
                                          "ml-auto w-4 h-4 stroke-1 shrink-0",
                                          column.id === sort.id
                                            ? "opacity-100"
                                            : "opacity-0",
                                        )}
                        ...
                        <SortableItemHandle asChild>
                          <Button
                            ...
                            className="size-8 shrink-0 rounded [&>svg]:size-3.5"
                          >
                            <GripVertical className="w-4 h-4 stroke-1" />
                          </Button>
                        </SortableItemHandle>
                      </div>
                    </SortableItem>
